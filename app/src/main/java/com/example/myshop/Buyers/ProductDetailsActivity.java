...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                if (state.equals("Đang giao hàng") || state.equals("Chưa vận chuyển"))
                {
                    Toast.makeText(ProductDetailsActivity.this, "Bạn có thể thêm mua thêm sản phẩm, khi đơn đặt hàng của bạn được vận chuyển hoặc xác nhận.", Toast.LENGTH_LONG).show();
                }
                else
                {
                    addingToCartList();
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("Đã giao hàng"))
                    {
                        state = "Đã giao hàng";
                    }
