...
import com.example.myshop.Sellers.SellerProductCategoryActivity;
    ...
    private void deleteThisProduct()
    {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                ...
                Toast.makeText(AdminMaintainProductsActivity.this, "Sản phẩm đã được xóa thành công.", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        else
        {
            ...
            productsRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    ...
                    {
                        Toast.makeText(AdminMaintainProductsActivity.this, "Thay đổi thành công.", Toast.LENGTH_SHORT).show();
